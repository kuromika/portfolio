      ...
      >
        <div className="flex flex-col md:flex-row md:text-xl md:w-[90%] lg:w-[80%] justify-between sm:gap-10">
          <div className="md:w-[50%] flex flex-col items-center justify-center">
            <h2 className="mb-5 self-start text-xl font-semibold after:block after:h-1 after:w-10 after:bg-black/70 after:content-[''] md:text-4xl">
              About me:
            </h2>
            <p>
          ...
          <div className="mt-5 flex flex-col sm:mt-0 sm:justify-center md:w-[50%]">
             <div className="h-[30vw] w-[100%] sm:h-[30vh] lg:h-[40vh] lg:w-[40vw] ">
            ...
            <div className="flex justify-between sm:justify-around md:flex-col md:gap-10 md:items-center lg:flex-row lg:items-start">
